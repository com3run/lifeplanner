...
class SqlDelightGamificationRepository(
    ...
    private suspend fun notifyWidgets() {
        try {
            ...
            Logger.w("SqlDelightGamificationRepository") { "Widget refresh failed: ${e.message}" }
        }
    }
    ...
    override suspend fun updateDailyStreakRemote(): Pair<Int, Int> {
        return try {
            ...
            Logger.w("SqlDelightGamificationRepository") { "updateDailyStreakRemote failed: ${e.message}" }
            Pair(0, 0)
        }
    }
