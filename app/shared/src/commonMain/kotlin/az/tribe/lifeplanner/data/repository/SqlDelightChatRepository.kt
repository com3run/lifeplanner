...
class SqlDelightChatRepository(
    ...
    override fun sendMessageStreaming(
        ...
        try {
                    ...
                    is AiProxyService.StreamEvent.Done -> {
                        ...
                        val metadataJson = if (suggestions.isNotEmpty()) {
                            try {
                                ...
                                Logger.w("SqlDelightChatRepository") { "Metadata encoding failed: ${e.message}" }
                                null
                            }
                        } else null
            ...
            Logger.e("SqlDelightChatRepository") { "Streaming failed: ${e.message}" }
            // Save partial text if we have any
            if (accumulated.isNotEmpty()) {
    ...
    internal suspend fun persistMemoryUpdate(
        ...
        try {
            ...
            Logger.w("SqlDelightChatRepository") { "Memory update write failed: ${e.message}" }
        }
    }
