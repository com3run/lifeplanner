...
CREATE TABLE IF NOT EXISTS coach_persona_overrides (
    coach_id     TEXT        NOT NULL,
    user_id      UUID        NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
DROP TRIGGER IF EXISTS trg_journal_entries_sync ON journal_entries;
...
DROP TRIGGER IF EXISTS trg_reminders_sync ON reminders;
CREATE TRIGGER trg_reminders_sync       BEFORE UPDATE ON reminders          FOR EACH ROW EXECUTE FUNCTION update_sync_metadata();
DROP TRIGGER IF EXISTS trg_custom_coaches_sync ON custom_coaches;
...
DROP TRIGGER IF EXISTS trg_coach_groups_sync ON coach_groups;
CREATE TRIGGER trg_coach_groups_sync    BEFORE UPDATE ON coach_groups       FOR EACH ROW EXECUTE FUNCTION update_sync_metadata();
DROP TRIGGER IF EXISTS trg_coach_grp_mbrs_sync ON coach_group_members;
...
DROP TRIGGER IF EXISTS trg_focus_sessions_sync ON focus_sessions;
...
DROP TRIGGER IF EXISTS trg_coach_persona_sync ON coach_persona_overrides;
...
-- users
CREATE INDEX IF NOT EXISTS idx_users_updated ON users(user_id, updated_at);
...
CREATE INDEX IF NOT EXISTS idx_milestones_goal    ON milestones(user_id, goal_id);
CREATE INDEX IF NOT EXISTS idx_milestones_updated ON milestones(user_id, updated_at);

-- goal_history
CREATE INDEX IF NOT EXISTS idx_goal_history_updated  ON goal_history(user_id, updated_at);
...
-- habit_check_ins
CREATE INDEX IF NOT EXISTS idx_checkins_user        ON habit_check_ins(user_id);
CREATE INDEX IF NOT EXISTS idx_checkins_user_habit  ON habit_check_ins(user_id, habit_id);
CREATE INDEX IF NOT EXISTS idx_checkins_updated     ON habit_check_ins(user_id, updated_at);

-- journal_entries
CREATE INDEX IF NOT EXISTS idx_journal_user_date    ON journal_entries(user_id, date);
CREATE INDEX IF NOT EXISTS idx_journal_user_goal    ON journal_entries(user_id, linked_goal_id);
CREATE INDEX IF NOT EXISTS idx_journal_user_habit   ON journal_entries(user_id, linked_habit_id);
CREATE INDEX IF NOT EXISTS idx_journal_updated      ON journal_entries(user_id, updated_at);

-- badges
CREATE INDEX IF NOT EXISTS idx_badges_user          ON badges(user_id);
CREATE INDEX IF NOT EXISTS idx_badges_user_type     ON badges(user_id, badge_type);
CREATE INDEX IF NOT EXISTS idx_badges_updated       ON badges(user_id, updated_at);

-- challenges
CREATE INDEX IF NOT EXISTS idx_challenges_user_type     ON challenges(user_id, challenge_type);
CREATE INDEX IF NOT EXISTS idx_challenges_user_completed ON challenges(user_id, is_completed);
CREATE INDEX IF NOT EXISTS idx_challenges_updated       ON challenges(user_id, updated_at);

-- goal_dependencies
CREATE INDEX IF NOT EXISTS idx_goal_deps_source     ON goal_dependencies(user_id, source_goal_id);
CREATE INDEX IF NOT EXISTS idx_goal_deps_target     ON goal_dependencies(user_id, target_goal_id);
CREATE INDEX IF NOT EXISTS idx_goal_deps_updated    ON goal_dependencies(user_id, updated_at);

-- chat_sessions
CREATE INDEX IF NOT EXISTS idx_chat_sessions_updated    ON chat_sessions(user_id, updated_at);

-- chat_messages
CREATE INDEX IF NOT EXISTS idx_chat_messages_user       ON chat_messages(user_id);
CREATE INDEX IF NOT EXISTS idx_chat_messages_session    ON chat_messages(user_id, session_id);
CREATE INDEX IF NOT EXISTS idx_chat_messages_updated    ON chat_messages(user_id, updated_at);

-- review_reports
CREATE INDEX IF NOT EXISTS idx_reviews_updated          ON review_reports(user_id, updated_at);

-- reminders
CREATE INDEX IF NOT EXISTS idx_reminders_user_goal      ON reminders(user_id, linked_goal_id);
CREATE INDEX IF NOT EXISTS idx_reminders_user_habit     ON reminders(user_id, linked_habit_id);
CREATE INDEX IF NOT EXISTS idx_reminders_updated        ON reminders(user_id, updated_at);

-- custom_coaches
CREATE INDEX IF NOT EXISTS idx_coaches_updated          ON custom_coaches(user_id, updated_at);

-- coach_groups
CREATE INDEX IF NOT EXISTS idx_coach_groups_updated     ON coach_groups(user_id, updated_at);

-- coach_group_members
CREATE INDEX IF NOT EXISTS idx_coach_grp_mbrs_updated   ON coach_group_members(user_id, updated_at);

-- focus_sessions
CREATE INDEX IF NOT EXISTS idx_focus_user_goal          ON focus_sessions(user_id, goal_id);
CREATE INDEX IF NOT EXISTS idx_focus_user_milestone     ON focus_sessions(user_id, milestone_id);
CREATE INDEX IF NOT EXISTS idx_focus_user_started       ON focus_sessions(user_id, started_at);
CREATE INDEX IF NOT EXISTS idx_focus_updated            ON focus_sessions(user_id, updated_at);

-- coach_persona_overrides
CREATE INDEX IF NOT EXISTS idx_coach_persona_user      ON coach_persona_overrides(user_id);
CREATE INDEX IF NOT EXISTS idx_coach_persona_updated   ON coach_persona_overrides(user_id, updated_at);

-- content_embeddings
CREATE INDEX IF NOT EXISTS idx_embeddings_user         ON content_embeddings(user_id);
CREATE INDEX IF NOT EXISTS idx_embeddings_source       ON content_embeddings(user_id, source_table, source_id);

-- ai_usage_logs
CREATE INDEX IF NOT EXISTS idx_ai_usage_user           ON ai_usage_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_ai_usage_created        ON ai_usage_logs(user_id, created_at);

-- FK indexes for cascade performance
CREATE INDEX IF NOT EXISTS idx_chat_messages_session_fk ON chat_messages(session_id);
CREATE INDEX IF NOT EXISTS idx_coach_grp_mbrs_group_fk ON coach_group_members(group_id);
CREATE INDEX IF NOT EXISTS idx_coach_persona_user_fk   ON coach_persona_overrides(user_id);
CREATE INDEX IF NOT EXISTS idx_focus_goal_fk           ON focus_sessions(goal_id);
CREATE INDEX IF NOT EXISTS idx_focus_milestone_fk      ON focus_sessions(milestone_id);
CREATE INDEX IF NOT EXISTS idx_goal_deps_source_fk     ON goal_dependencies(source_goal_id);
CREATE INDEX IF NOT EXISTS idx_goal_deps_target_fk     ON goal_dependencies(target_goal_id);
CREATE INDEX IF NOT EXISTS idx_checkins_habit_fk       ON habit_check_ins(habit_id);
CREATE INDEX IF NOT EXISTS idx_habits_goal_fk          ON habits(linked_goal_id);
CREATE INDEX IF NOT EXISTS idx_journal_goal_fk         ON journal_entries(linked_goal_id);
CREATE INDEX IF NOT EXISTS idx_journal_habit_fk        ON journal_entries(linked_habit_id);
CREATE INDEX IF NOT EXISTS idx_milestones_goal_fk      ON milestones(goal_id);
CREATE INDEX IF NOT EXISTS idx_reminders_goal_fk       ON reminders(linked_goal_id);
CREATE INDEX IF NOT EXISTS idx_reminders_habit_fk      ON reminders(linked_habit_id);
...
DROP POLICY IF EXISTS goal_history_delete ON goal_history;
...
DROP POLICY IF EXISTS habit_check_ins_delete ON habit_check_ins;
...
DROP POLICY IF EXISTS goal_dependencies_select ON goal_dependencies;
CREATE POLICY goal_dependencies_select ON goal_dependencies FOR SELECT TO authenticated USING ((select auth.uid()) = user_id);
DROP POLICY IF EXISTS goal_dependencies_insert ON goal_dependencies;
...
DROP POLICY IF EXISTS goal_dependencies_update ON goal_dependencies;
...
DROP POLICY IF EXISTS goal_dependencies_delete ON goal_dependencies;
...
DROP POLICY IF EXISTS review_reports_delete ON review_reports;
...
DROP POLICY IF EXISTS coach_groups_delete ON coach_groups;
...
DROP POLICY IF EXISTS coach_group_members_select ON coach_group_members;
...
DROP POLICY IF EXISTS coach_group_members_insert ON coach_group_members;
...
DROP POLICY IF EXISTS coach_group_members_update ON coach_group_members;
...
DROP POLICY IF EXISTS coach_group_members_delete ON coach_group_members;
...
DROP POLICY IF EXISTS coach_persona_overrides_select ON coach_persona_overrides;
...
DROP POLICY IF EXISTS coach_persona_overrides_insert ON coach_persona_overrides;
...
DROP POLICY IF EXISTS coach_persona_overrides_update ON coach_persona_overrides;
...
DROP POLICY IF EXISTS coach_persona_overrides_delete ON coach_persona_overrides;
...
DROP POLICY IF EXISTS content_embeddings_insert ON content_embeddings;
...
DROP POLICY IF EXISTS content_embeddings_update ON content_embeddings;
...
DROP POLICY IF EXISTS content_embeddings_delete ON content_embeddings;
...
DROP POLICY IF EXISTS user_situations_delete ON user_situations;
CREATE POLICY user_situations_delete ON user_situations FOR DELETE TO authenticated USING ((select auth.uid()) = user_id);

DROP TRIGGER IF EXISTS trg_user_situations_sync ON user_situations;
...
DROP POLICY IF EXISTS life_values_delete ON life_values;
CREATE POLICY life_values_delete ON life_values FOR DELETE TO authenticated USING ((select auth.uid()) = user_id);

DROP TRIGGER IF EXISTS trg_life_values_sync ON life_values;
...
DROP TRIGGER IF EXISTS trg_decisions_sync ON decisions;
...
CREATE INDEX IF NOT EXISTS idx_identity_statements_value ON identity_statements(value_id);

ALTER TABLE identity_statements ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS identity_statements_select ON identity_statements;
...
DROP POLICY IF EXISTS identity_statements_insert ON identity_statements;
...
DROP POLICY IF EXISTS identity_statements_update ON identity_statements;
...
DROP POLICY IF EXISTS identity_statements_delete ON identity_statements;
...
DROP TRIGGER IF EXISTS trg_identity_statements_sync ON identity_statements;
...
CREATE INDEX IF NOT EXISTS idx_decision_profiles_user_id ON decision_profiles(user_id);

ALTER TABLE decision_profiles ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS decision_profiles_select ON decision_profiles;
CREATE POLICY decision_profiles_select ON decision_profiles FOR SELECT TO authenticated USING ((select auth.uid()) = user_id);
DROP POLICY IF EXISTS decision_profiles_insert ON decision_profiles;
...
DROP POLICY IF EXISTS decision_profiles_update ON decision_profiles;
...
DROP POLICY IF EXISTS decision_profiles_delete ON decision_profiles;
CREATE POLICY decision_profiles_delete ON decision_profiles FOR DELETE TO authenticated USING ((select auth.uid()) = user_id);

DROP TRIGGER IF EXISTS trg_decision_profiles_sync ON decision_profiles;
